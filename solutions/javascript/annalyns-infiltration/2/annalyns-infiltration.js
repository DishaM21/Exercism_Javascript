...
export function canFreePrisoner(
  ...
  if(knightIsAwake === false && archerIsAwake === true && prisonerIsAwake === true && petDogIsPresent === false){
    return false;
  }
  if(knightIsAwake === false && archerIsAwake === true && prisonerIsAwake === true && petDogIsPresent === true){
    return false;
  }
  if(knightIsAwake === true && archerIsAwake === false && prisonerIsAwake === false && petDogIsPresent === false){
    return false;
  }
  if(knightIsAwake === true && archerIsAwake === false && prisonerIsAwake === false && petDogIsPresent === true){
    return true;
  }
  if(knightIsAwake === true && archerIsAwake === false && prisonerIsAwake === true && petDogIsPresent === false){
    return false;
  }
  ...
  if(knightIsAwake === true && archerIsAwake === true && prisonerIsAwake === false && petDogIsPresent === false){
    return false;
  }
